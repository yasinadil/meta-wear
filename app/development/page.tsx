...
export default function Development() {
  return (
    <>
      <Head>
        <title>Development | Stealth Meta Wear</title>
            ...
            <div className="mb-8 flex justify-between flex-col items-end w-[75%] right-timeline">
              ...
              <div className="order-1 rounded-lg shadow-xl w-1/3 px-6 py-4">
                ...
                <p className="text-sm leading-snug tracking-wide text-[#e7d17a] text-center">
                  ...
                  world. The core of the collection are 6 unique full body
                  design and over 100 collectable assets that can be combine to
            ...
            <div className="mb-8 flex justify-between flex-col items-end w-[50%] left-timeline">
              ...
              <div className="order-1 w-1/2 px-6 py-4">
                ...
                <p className="text-sm leading-snug tracking-wide text-center text-gray-700">
                  ...
                  collection is designed to bring bright colors and combine
                  metal with future tech.
                </p>
              </div>
            </div>
          ...
          <div className="block md:hidden">
            <div className="my-4 px-4">
              ...
              <p className="text-xl leading-snug tracking-wide text-center text-[#e7d17a]">
                ...
                developers with many years of experience on AAA titles. We
                started the project with the goal of developing awesome looking
                digital clothing that can be used in your favorite games or
                platforms.
              </p>
            </div>
            <div className="my-4 px-4">
            ...
            <div className="my-4 px-4">
              ...
              <p className="text-xl leading-snug tracking-wide text-center text-gray-500">
                ...
                imported inside game engines like Unreal or can be imported
                inside games that allow for user generated content.
              </p>
            </div>
            <div className="my-4 px-4">
              <div className="divider bg-[#e7d17a] mt-0 h-0.5"></div>
              ...
              <p className="text-xl leading-snug tracking-wide text-center text-gray-500">
                Developing and supporting our project economy with a Stealth
                Meta Wear Token.
              </p>
            </div>
            <div className="my-4 px-4">
              ...
              <p className="text-xl leading-snug tracking-wide text-center text-gray-500">
                We are developing an application that will allow users to buy
                and trade digital clothing. We are also working on set of
                features that will allow you to create content using your NFT
                collection assets.
              </p>
            </div>
            <div className="my-4 px-4">
              ...
              <p className="text-xl leading-snug tracking-wide text-center text-gray-500">
                An exiting collection that is inspired by K-Pop and modern
                looks. We are pushing so everything looks slick and clean while
                being supported by animated graphical elements.
              </p>
            </div>
          </div>
        </div>
